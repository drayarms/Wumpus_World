...
public:
	...
	Action determineTurnDirection(int oldX, int oldY, int newX, int newY, bool shootArrow);//Determine which direction to turn base on what col x and row y agent has chosen
